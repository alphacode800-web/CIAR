...
export const CIAR_MODULES: ModuleSeed[] = [
  ...
  { slug: "TOURISM", nameEn: "CIAR Tourism", nameAr: "CiAr الوسيط السياحي", descriptionEn: "Tourism broker for all countries, agencies, and distinguished offers.", descriptionAr: "الوسيط السياحي لكافة دول وشركات العالم وخدمات وعروض مميزة.", visibility: "VISIBLE", order: 5 },
  { slug: "REAL_ESTATE", nameEn: "CIAR Real Estate", nameAr: "CiAr للتسويق العقاري", descriptionEn: "Buy, sell, and rent all types of real estate.", descriptionAr: "بيع وشراء وأجار كافة انواع العقارات.", visibility: "VISIBLE", order: 6 },
  { slug: "CARS", nameEn: "CIAR Car Trading", nameAr: "CiAr لتجارة السيارات", descriptionEn: "Buy, sell, and rent all types of cars.", descriptionAr: "بيع وشراء وأجار كافة انواع السيارات.", visibility: "VISIBLE", order: 7 },
  { slug: "SERVICES", nameEn: "CIAR Home & Office Services", nameAr: "CiAr لصيانة المنازل والمكاتب", descriptionEn: "Home and office maintenance with cleaning services.", descriptionAr: "لصيانة المنازل والمكاتب وخدمات التنظيف.", visibility: "VISIBLE", order: 8 },
  { slug: "SHIPPING", nameEn: "CIAR Global Shipping", nameAr: "CiAr للشحن العالمي", descriptionEn: "Worldwide shipping by land, sea, and air.", descriptionAr: "الشحن العالمي برا وبحرا وجوا إلى كافة دول العالم.", visibility: "VISIBLE", order: 9 },
  { slug: "JOBS", nameEn: "CIAR Jobs & Housing", nameAr: "CiAr لشواغr التوظيف", descriptionEn: "Job vacancies, career search, and employee housing options.", descriptionAr: "شواغر التوظيف والبحث عن العمل وسكن موظفين.", visibility: "VISIBLE", order: 10 },
