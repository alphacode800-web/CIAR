...
export function AdminHeader({
  ...
  return (
    <header className="sticky top-0 z-30 flex items-center justify-between gap-4 px-4 sm:px-6 h-14 border-b border-[oklch(0.78_0.14_82/10%)] bg-[oklch(0.12_0.028_265/80%)] backdrop-blur-xl">
      {/* ── Left Section ── */}
      ...
      <div className="hidden md:flex items-center justify-center flex-1 max-w-sm">
        <button
          ...
          className={cn(
            "flex items-center gap-2 w-full max-w-xs px-3.5 py-2 rounded-lg",
            "border border-[oklch(0.78_0.14_82/12%)] bg-[oklch(0.14_0.028_265/50%)]",
            "text-muted-foreground text-sm transition-all duration-200",
            "hover:border-[oklch(0.78_0.14_82/25%)] hover:bg-[oklch(0.14_0.028_265/70%)]",
        ...
        >
          ...
          <kbd className="hidden sm:inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded text-[10px] font-mono text-muted-foreground/40 bg-muted/50 border border-border/50">
