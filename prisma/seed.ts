...
const projectTranslations: Record<string, Record<string, { name: string; tagline: string; description: string }>> = {
  'ciar-realestate': {
    ...
    ar: { name: 'سيار العقارات', tagline: 'اكتشف عقار أحلامك بثقة', description: 'سيار العقارات هي منصة عقارية متميزة تربط بين المشترين والبائعين والمستأجرين مع أرقى العقارات. تشمل جولات افتراضية ومطابقة عقارات بالذكاء الاصطناعي.' },
  ...
  'ciar-carrental': {
    ...
    ar: { name: 'سيار لتأجير السيارات', tagline: 'اقُد التميّز، استأجر بساطة', description: 'سيار لتأجير السيارات تقدم تجربة تأجير سلسة مع أسطول متنوع من السيارات الفاخرة. تشمل التوفر الفوري والملاحة GPS والتأمين.' },
  ...
  'ciar-mall': {
    ...
    ar: { name: 'سيار مول', tagline: 'تجربة تسوقك المميزة', description: 'سيار مول هي منصة تجارة إلكترونية شاملة تضم آلاف العلامات التجارية في الموضة والإلكترونيات والمنزل والمزيد.' },
  ...
  'ciar-travel': {
    ...
    ar: { name: 'سيار للسياحة', tagline: 'استكشف العالم، وجهة واحدة في كل مرة', description: 'سيار للسياحة هي رفيق سفرك المثالي، تقدم باقات سياحية مختارة وحجز الفنادق وحجز الطيران والأدلة المحلية.' },
  ...
  'ciar-food': {
    ...
    ar: { name: 'سيار فود', tagline: 'وجبات لذيذة تصل لباب بيتك', description: 'سيار فود تربطك بأفضل المطاعم والطهاة في مدينتك. اطلب وجباتك المفضلة مع تتبع فوري وجدول deliveries.' },
  ...
  'ciar-education': {
    ...
    ar: { name: 'سيار أكاديمي', tagline: 'تعلّم بلا حدود، نمُ بلا حدود', description: 'سيار أكاديمي هي منصة تعليم إلكتروني شاملة تقدم دورات مهنية وشهادات وبرامج تطوير المهارات.' },
  ...
  'ciar-health': {
    ...
    ar: { name: 'سيار الصحة', tagline: 'صحتك، أولويتنا', description: 'سيار الصحة تقدم خدمات رعاية صحية شاملة تشمل الاستشارات عبر الإنترنت وحجز المواعيد وإدارة السجلات الطبية.' },
  ...
  'ciar-logistics': {
    ...
    ar: { name: 'سيار اللوجستيات', tagline: 'ندفع أعمالك للأمام، دائماً في الوقت', description: 'سيار اللوجستيات تقدم حلول سلسلة إمداد شاملة تشمل الشحن والتخزين وإدارة الأسطول والتوصيل للميل الأخير.' },
...
const translations: Record<string, Record<string, string>> = {
  ...
  'nav.about': { en: 'About', ar: 'عن سيار', fr: 'À propos', es: 'Acerca de', de: 'Über uns' },
  ...
  'about.badge': { en: 'About CIAR', ar: 'عن سيار', fr: 'À propos de CIAR', es: 'Acerca de CIAR', de: 'Über CIAR' },
  ...
  'footer.brand': { en: 'CIAR', ar: 'سيار', fr: 'CIAR', es: 'CIAR', de: 'CIAR' },
  ...
  'footer.product_3': { en: 'CIAR Mall', ar: 'سيار مول', fr: 'CIAR Mall', es: 'CIAR Mall', de: 'CIAR Mall' },
